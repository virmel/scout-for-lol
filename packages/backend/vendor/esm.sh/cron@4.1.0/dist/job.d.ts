...
> {
  ...
  onComplete?: WithOnComplete<OC> extends true ? CronOnCompleteCallback
    : undefined;
  ...
  nextDate(): import("https://esm.sh/@types/luxon@3.4.2/index.d.ts").DateTime<
    boolean
  >;
  fireOnTick(): Promise<void>;
  nextDates(
    i?: number,
  ): import("https://esm.sh/@types/luxon@3.4.2/index.d.ts").DateTime<boolean>[];
  start(): void;
  lastDate(): Date | null;
