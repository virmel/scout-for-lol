/* esm.sh - axios@1.8.3/unsafe/helpers/buildURL */
import a from "../utils.mjs";
import d from "../../lib/helpers/AxiosURLSearchParams.mjs";
function l(e) {
...
function g(e, c, i) {
  ...
  let n = i && i.serialize, r;
  if (
    n
      ? r = n(c, i)
      : r = a.isURLSearchParams(c) ? c.toString() : new d(c, i).toString(f), r
  ) {
    let t = e.indexOf("#");
    t !== -1 && (e = e.slice(0, t)),
      e += (e.indexOf("?") === -1 ? "?" : "&") + r;
