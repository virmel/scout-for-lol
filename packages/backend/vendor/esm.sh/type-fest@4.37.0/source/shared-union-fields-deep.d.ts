...
> =
  ...
  [Union] extends
    ...
    : [Union] extends [UnknownArray]
      ? Options["recurseIntoArrays"] extends true ? SetArrayAccess<
          SharedArrayUnionFieldsDeep<Union, Options>,
          IsArrayReadonly<Union>
        >
      : Union
    : [Union] extends [object] ? SharedObjectUnionFieldsDeep<Union, Options>
    : Union;
...
> =
  ...
  keyof Union extends infer Keys ? IsNever<Keys> extends false ? {
        [Key in keyof Union]: Union[Key] extends NonRecursiveType ? Union[Key]
