...
export type SetRequiredDeep<BaseType, KeyPaths extends Paths<BaseType>> =
  IsAny<KeyPaths> extends true ? SimplifyDeep<RequiredDeep<BaseType>>
...
*/
type SetRequiredDeepSinglePath<BaseType, KeyPath> = BaseType extends
  NonRecursiveType ? BaseType
