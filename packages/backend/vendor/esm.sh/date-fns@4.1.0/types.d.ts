import { type constructFromSymbol } from "./constants.d.ts";
import type { Locale } from "./locale/types.d.ts";
export type * from "./fp/types.d.ts";
export type * from "./locale/types.d.ts";
/**
 * The argument type.
 */
