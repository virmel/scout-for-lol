...
import * as CSS from "https://esm.sh/csstype@3.1.3/index.d.ts";
...
declare namespace React {
  ...
  type PropsWithoutRef<Props> =
    ...
    Props extends any ? ("ref" extends keyof Props ? Omit<Props, "ref"> : Props)
      : Props;
  /**
  ...
  type ReducerState<R extends Reducer<any, any>> = R extends
    Reducer<infer S, any> ? S : never;
  ...
  namespace JSX {
    ...
    type LibraryManagedAttributes<C, P> = C extends
      ...
      ? T extends
        React.MemoExoticComponent<infer U> | React.LazyExoticComponent<infer U>
