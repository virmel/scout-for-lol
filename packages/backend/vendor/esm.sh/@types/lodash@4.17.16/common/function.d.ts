...
declare module "../index.d.ts" {
  ...
  interface Function<T extends (...args: any) => any> {
    ...
    curry(
      ...
      : T extends (
        ...
        arg3: infer T3,
        arg4: infer T4,
      ) => infer R ? Function<CurriedFunction4<T1, T2, T3, T4, R>>
      : T extends (
        arg1: infer T1,
        arg2: infer T2,
        arg3: infer T3,
        arg4: infer T4,
        arg5: infer T5,
      ) => infer R ? Function<CurriedFunction5<T1, T2, T3, T4, T5, R>>
  ...
  interface Function<T extends (...args: any) => any> {
    ...
    curryRight(
      ...
      : T extends (
        ...
        arg3: infer T3,
        arg4: infer T4,
      ) => infer R ? Function<RightCurriedFunction4<T1, T2, T3, T4, R>>
      : T extends (
        arg1: infer T1,
        arg2: infer T2,
        arg3: infer T3,
        arg4: infer T4,
        arg5: infer T5,
      ) => infer R ? Function<RightCurriedFunction5<T1, T2, T3, T4, T5, R>>
      : Function<(...args: any[]) => any>;
  }
  interface FunctionChain<T extends (...args: any) => any> {
    /**
  ...
  interface Function<T extends (...args: any) => any> {
    ...
    debounce(
      wait: number | undefined,
      options: DebounceSettingsLeading,
    ): T extends (...args: any[]) => any ? Function<DebouncedFuncLeading<T>>
      : never;
    debounce(
      wait?: number,
      options?: DebounceSettings,
