...
declare module "../index.d.ts" {
  ...
  type GetFieldTypeOfStringByKey<T extends string, K> = K extends number ? T[K]
    : K extends `${infer N extends number}` ? T[N]
    : K extends keyof T ? T[K]
    : undefined;
  ...
  type GetFieldTypeOfNarrowedByLcKR<T, Lc, K, R> = "" extends R
    ...
    : R extends `.${infer Rc}` ? GetFieldType<
        GetFieldType<GetFieldTypeOfNarrowedByDotPath<T, Lc>, K, "Key">,
        Rc
      >
    : GetFieldType<
  ...
  type GetFieldTypeOfNarrowedByLKR<T, L, K, R> = "" extends L
    ? "" extends R ? GetFieldTypeOfNarrowedByKey<T, K>
    : R extends `.${infer Rc}`
      ? GetFieldType<GetFieldTypeOfNarrowedByKey<T, K>, Rc>
    : GetFieldType<GetFieldTypeOfNarrowedByKey<T, K>, R>
    : L extends `${infer Lc}.` ? GetFieldTypeOfNarrowedByLcKR<T, Lc, K, R>
  ...
  type GetFieldTypeOfObject<T, X, XT extends "DotPath" | "Key" | "Path"> =
    Extract<T, unknown[]> extends never ? GetFieldTypeOfNarrowed<T, X, XT>
      :
  ...
  type GetFieldTypeOfPrimitive<T, X, XT extends "DotPath" | "Key" | "Path"> =
    Extract<T, string> extends never ? T extends never ? never : undefined
      :
  ...
  type GetFieldType<T, X, XT extends "DotPath" | "Key" | "Path" = "Path"> =
    Extract<T, object> extends never ? GetFieldTypeOfPrimitive<T, X, XT>
      :
  ...
  interface ObjectChain<T> {
    ...
    get<TPath extends string>(
      path: TPath,
    ): string extends TPath ? LoDashExplicitWrapper<any>
  ...
  interface LoDashStatic {
    ...
    has<T, K extends PropertyName>(
      ...
      & T
      & {
        [P in K]: P extends keyof T ? T[P]
          : Record<string, unknown> extends T ? T[keyof T]
          : unknown;
      }
  ...
  interface Object<T> {
    ...
    pickBy<S extends T[keyof T]>(
      ...
      NumericDictionary<unknown> extends T ? NumericDictionary<S>
        : Dictionary<S>
    >;
    /**
     * @see _.pickBy
    ...
    pickBy(
      ...
      T extends Dictionary<unknown> ? Dictionary<T[keyof T]>
        : T extends NumericDictionary<unknown> ? NumericDictionary<T[keyof T]>
        : PartialObject<T>
    >;
  }
  interface CollectionChain<T> {
