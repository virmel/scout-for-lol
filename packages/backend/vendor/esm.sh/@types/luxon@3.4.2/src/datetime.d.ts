...
import { Duration, DurationLike, DurationUnits } from "./duration.d.ts";
import { Interval } from "./interval.d.ts";
import { Zone } from "./zone.d.ts";
...
export type DateTimeMaybeValid = CanBeInvalid extends true
