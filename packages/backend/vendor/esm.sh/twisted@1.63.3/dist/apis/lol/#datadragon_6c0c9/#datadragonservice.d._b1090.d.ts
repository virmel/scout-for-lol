import { RealmServers } from '../../../constants/realmServers.d.ts';
import { RealmDTO, ChampionsDataDragon, QueuesDataDragonDTO, GameModesDataDragonDTO } from '../../../models-dto/index.d.ts';
import { Champions } from '../../../constants/champions.d.ts';
import { ChampionsDataDragonDetailsSolo } from '../../../models-dto/data-dragon/champions.datadragon.dto.d.ts';
import { MapsDataDragonDTO } from '../../../models-dto/data-dragon/maps.datadragon.dto.d.ts';
import { GameTypesDataDragonDTO } from '../../../models-dto/data-dragon/game-types.datadragon.dto.d.ts';
import { RunesReforgedDTO } from '../../../models-dto/data-dragon/runes-reforged.dto.d.ts';
/**
