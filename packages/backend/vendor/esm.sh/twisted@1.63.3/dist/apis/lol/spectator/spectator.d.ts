...
export declare class SpectatorApi extends BaseApiLol {
     ...
     * @param region
     */
    featuredGames(region: Regions): Promise<import("../../../models-dto/index.d.ts").ApiResponseDTO<FeaturedGamesDTO>>;
    /**
     * Get summoner active game
     * @param encryptedSummonerId
     * @param region
     */
    activeGame(encryptedSummonerId: string, region: Regions): Promise<SpectatorNotAvailableDTO | import("../../../models-dto/index.d.ts").ApiResponseDTO<CurrentGameInfoDTO>>;
}
