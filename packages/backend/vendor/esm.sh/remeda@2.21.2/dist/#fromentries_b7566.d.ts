...
type FromEntries<Entries> = Entries extends readonly [
  ...
  : Entries extends IterableContainer<Entry> ? FromEntriesArray<Entries>
...
type FromEntriesArray<Entries extends IterableContainer<Entry>> = string extends
  AllKeys<Entries> ? Record<string, Entries[number][1]>
...
> = (Extract<Entries[number], Entry<K>> extends never ? Entries[number]
 ...
 * @category Object
 */
declare function fromEntries<Entries extends IterableContainer<Entry>>(
  entries: Entries,
