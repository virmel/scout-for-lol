...
import { CronCallback, CronContext, CronJobParams, CronOnCompleteCallback, CronOnCompleteCommand, WithOnComplete } from './types/cron.types.d.ts';
export declare class CronJob<OC extends CronOnCompleteCommand | null = null, C = null> {
    ...
    nextDate(): import("https://esm.sh/@types/luxon@3.6.2/index.d.ts").DateTime<boolean>;
    fireOnTick(): Promise<void>;
    nextDates(i?: number): import("https://esm.sh/@types/luxon@3.6.2/index.d.ts").DateTime<boolean>[];
    start(): void;
    lastDate(): Date | null;
