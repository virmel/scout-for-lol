...
interface Scope$1 {
  ...
  setPropagationContext(
    context:
      & Omit<PropagationContext, "spanId">
      & Partial<Pick<PropagationContext, "spanId">>,
  ): this;
  /**
...
type AttachmentItem = BaseEnvelopeItem<
...
interface Client<O extends ClientOptions = ClientOptions> {
  ...
  on(
    ...
    callback: (feedback: FeedbackEvent, options?: {
  ...
  on(
    ...
    callback: (options: StartSpanOptions, traceOptions?: {
 ...
 */
declare function propagationContextFromHeaders(
  sentryTrace: string | undefined,
 ...
 * it may just be a non-recording span if the span is not sampled or if tracing is disabled.
 */
declare function startSpanManual<T>(
  options: StartSpanOptions,
 ...
 * }
 */
declare abstract class BaseClient<O extends ClientOptions>
  implements Client<O> {
...
interface ServerRuntimeClientOptions
  extends ClientOptions<BaseTransportOptions> {
  platform?: string;
  runtime?: {
    name: string;
    version?: string;
 ...
 */
declare class ServerRuntimeClient<
  O extends ClientOptions & ServerRuntimeClientOptions =
 ...
 */
declare const requestDataIntegration: (
 ...
 */
declare function setMeasurement(
  name: string,
  value: number,
  unit: MeasurementUnit,
 ...
 * @returns the id of the captured message.
 */
declare function captureMessage(
  message: string,
 ...
 * to create a monitor automatically when sending a check in.
 */
declare function captureCheckIn(
  checkIn: CheckIn,
 ...
 * to create a monitor automatically when sending a check in.
 */
declare function withMonitor<T>(
 ...
 */
declare function withIsolationScope<T>(
 ...
 * @param makeRequest
 */
declare function createTransport(
 ...
 */
declare function addBreadcrumb(
  breadcrumb: Breadcrumb,
  hint?: BreadcrumbHint,
): void;
...
declare const linkedErrorsIntegration: (
 ...
 */
declare const captureConsoleIntegration: (
 ...
 */
declare const debugIntegration: (
...
declare const extraErrorDataIntegration: (
 ...
 */
declare const rewriteFramesIntegration: (
 ...
 */
declare const zodErrorsIntegration: (
 ...
 */
declare function getMetricsAggregatorForClient(
  client: Client,
): MetricsAggregator;
/**
 ...
 */
declare function captureFeedback(
 ...
 */
interface DenoClientOptions
  extends ClientOptions<DenoTransportOptions>, BaseDenoOptions {
}
 ...
 * ```
 */
declare const globalHandlersIntegration: (
  options?: GlobalHandlersIntegrations | undefined,
) => Integration;
 ...
 * ```
 */
declare const contextLinesIntegration: (
  options?: ContextLinesOptions | undefined,
) => Integration;
 ...
 * ```
 */
declare const breadcrumbsIntegration: (
