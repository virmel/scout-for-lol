...
export type inferFlattenedErrors<T extends ZodType<any, any, any>, U = string> =
...
export type inferFormattedError<T extends ZodType<any, any, any>, U = string> =
...
type stripPath<T extends object> = T extends any ? util.OmitKeys<T, "path">
  : never;
