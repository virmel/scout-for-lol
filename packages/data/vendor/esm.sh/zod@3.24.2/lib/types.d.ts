import { enumUtil } from "./helpers/enumUtil.d.ts";
import { errorUtil } from "./helpers/errorUtil.d.ts";
import {
  ...
  ParseStatus,
  SyncParseReturnType,
} from "./helpers/parseUtil.d.ts";
import { partialUtil } from "./helpers/partialUtil.d.ts";
import { Primitive } from "./helpers/typeAliases.d.ts";
import { objectUtil, util } from "./helpers/util.d.ts";
...
export declare class ZodBoolean
...
export declare class ZodUndefined
...
export declare class ZodUnknown
...
> extends ZodType<
  ...
  ZodArrayDef<T>,
  Cardinality extends "atleastone" ? [T["_input"], ...T["_input"][]]
    : T["_input"][]
> {
  _parse(input: ParseInput): ParseReturnType<this["_output"]>;
  get element(): T;
...
export type PassthroughType<T extends UnknownKeysParam> = T extends
  "passthrough" ? {
    [k: string]: unknown;
  }
  : unknown;
export type deoptional<T extends ZodTypeAny> = T extends ZodOptional<infer U>
  ? deoptional<U>
  : T extends ZodNullable<infer U> ? ZodNullable<deoptional<U>>
  : T;
...
> extends ZodType<Output, ZodObjectDef<T, UnknownKeys, Catchall>, Input> {
  ...
  static create: <T_1 extends ZodRawShape>(
    ...
    "strip",
    ZodTypeAny,
    objectUtil.addQuestionMarks<baseObjectOutputType<T_1>, any> extends
      infer T_2 ? {
...
export declare class ZodUnion<T extends ZodUnionOptions>
...
export declare class ZodIntersection<T extends ZodTypeAny, U extends ZodTypeAny>
  extends ZodType<
    T["_output"] & U["_output"],
...
export type OutputTypeOfTuple<T extends ZodTupleItems | []> = AssertArray<
  {
    [k in keyof T]: T[k] extends ZodType<any, any, any> ? T[k]["_output"]
      : never;
  }
>;
...
> = Rest extends ZodTypeAny ? [...OutputTypeOfTuple<T>, ...Rest["_output"][]]
  : OutputTypeOfTuple<T>;
export type InputTypeOfTuple<T extends ZodTupleItems | []> = AssertArray<
  {
    [k in keyof T]: T[k] extends ZodType<any, any, any> ? T[k]["_input"]
      : never;
  }
>;
export type InputTypeOfTupleWithRest<
  T extends ZodTupleItems | [],
  Rest extends ZodTypeAny | null = null,
> = Rest extends ZodTypeAny ? [...InputTypeOfTuple<T>, ...Rest["_input"][]]
  : InputTypeOfTuple<T>;
...
export type RecordType<K extends string | number | symbol, V> = [
  string,
] extends [K] ? Record<K, V>
  : [number] extends [K] ? Record<K, V>
  : [symbol] extends [K] ? Record<K, V>
  : [BRAND<string | number | symbol>] extends [K] ? Record<K, V>
  : Partial<Record<K, V>>;
...
export declare class ZodSet<Value extends ZodTypeAny = ZodTypeAny>
  extends ZodType<
    Set<Value["_output"]>,
    ZodSetDef<Value>,
    Set<Value["_input"]>
...
export declare class ZodLazy<T extends ZodTypeAny>
...
export declare class ZodEnum<T extends [string, ...string[]]>
...
export declare class ZodNativeEnum<T extends EnumLike>
...
export declare class ZodNullable<T extends ZodTypeAny>
...
export declare class ZodCatch<T extends ZodTypeAny>
...
export declare class ZodPipeline<A extends ZodTypeAny, B extends ZodTypeAny>
...
type BuiltIn =
  ...
  | Promise<unknown>
  | RegExp;
type MakeReadonly<T> = T extends Map<infer K, infer V> ? ReadonlyMap<K, V>
