...
export type Schema<ObjectType, ValueType, Options extends SchemaOptions = {}> =
  ObjectType extends string ? ValueType
    ...
    : ObjectType extends Array<infer U>
      ? Options["recurseIntoArrays"] extends false | undefined ? ValueType
    ...
    : ObjectType extends object ? SchemaObject<ObjectType, ValueType, Options>
    : ValueType;
...
> = {
  [KeyType in keyof ObjectType]: ObjectType[KeyType] extends
    | readonly unknown[]
    | unknown[] ? Options["recurseIntoArrays"] extends false | undefined ? K
