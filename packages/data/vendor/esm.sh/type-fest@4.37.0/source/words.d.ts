...
> = Sentence extends `${infer LeftSide}${Character}` ? SkipEmptyWord<LeftSide>
  : never;
...
export type Words<Sentence extends string, Options extends WordsOptions = {}> =
  WordsImplementation<Sentence, {
    splitOnNumbers: Options["splitOnNumbers"] extends boolean
      ? Options["splitOnNumbers"]
      : DefaultOptions["splitOnNumbers"];
  }>;
...
> = Sentence extends `${infer FirstCharacter}${infer RemainingCharacters}`
  ...
  : [true, true] extends
    [IsLowerCase<LastCharacter>, IsUpperCase<FirstCharacter>] ? [
      ...SkipEmptyWord<CurrentWord>,
      ...WordsImplementation<
        RemainingCharacters,
        Options,
  ...
  : [true, true] extends
    [IsUpperCase<LastCharacter>, IsLowerCase<FirstCharacter>] ? [
