...
import { MergeUnion, Primitives, WithDefault } from "./helpers.d.ts";
import { None, SelectionType, Some } from "./FindSelected.d.ts";
import { matcher } from "../patterns.d.ts";
import { ExtractPreciseValue } from "./ExtractPreciseValue.d.ts";
 ...
 */
export type Pattern<a = unknown> = unknown extends a ? UnknownPattern
  : KnownPattern<a>;
