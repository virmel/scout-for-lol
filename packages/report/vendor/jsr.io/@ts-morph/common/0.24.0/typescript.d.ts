...
declare namespace ts {
  namespace server {
    namespace protocol {
       ...
       */
      export interface SpanOfEnclosingCommentRequest
      ...
      export type FileLocationOrRangeRequestArgs =
       ...
       */
      export interface GetMoveToRefactoringFileSuggestionsRequest
        extends Request {
      ...
      export interface DefinitionAndBoundSpanRequest
        extends FileLocationRequest {
      ...
      export interface FileSpanWithContext
        extends FileSpan, TextSpanWithContext {
      }
       ...
       */
      export interface BraceCompletionRequestArgs
        extends FileLocationRequestArgs {
        /**
      ...
      export interface JsxClosingTagRequestArgs
        extends FileLocationRequestArgs {
      }
       ...
       */
      export interface CompileOnSaveAffectedFileListRequest
        extends FileRequest {
       ...
       */
      export interface SignatureHelpRequestArgs
        extends FileLocationRequestArgs {
        /**
      ...
      export interface SemanticDiagnosticsSyncRequestArgs
        extends FileRequestArgs {
        includeLinePosition?: boolean;
      }
      /**
      ...
      export interface SyntacticDiagnosticsSyncRequestArgs
        extends FileRequestArgs {
        includeLinePosition?: boolean;
      }
      /**
      ...
      export interface BeginInstallTypesEventBody
      ...
      export interface ProvideCallHierarchyIncomingCallsResponse
        extends Response {
      ...
      export interface ProvideCallHierarchyOutgoingCallsResponse
        extends Response {
  ...
  interface Identifier
    extends PrimaryExpression, Declaration, JSDocContainer, FlowContainer {
  ...
  interface ClassStaticBlockDeclaration
    extends ClassElement, JSDocContainer, LocalsContainer {
  ...
  interface FunctionTypeNode
    extends FunctionOrConstructorTypeNodeBase, LocalsContainer {
  ...
  interface ExpressionWithTypeArguments
    extends MemberExpression, NodeWithTypeArguments {
  ...
  interface ForStatement
    extends IterationStatement, LocalsContainer, FlowContainer {
  ...
  interface TypeAliasDeclaration
    extends DeclarationStatement, JSDocContainer, LocalsContainer {
  ...
  interface JSDocFunctionType
    extends JSDocType, SignatureDeclarationBase, LocalsContainer {
  ...
  interface JSDocTypedefTag
    extends JSDocTag, NamedDeclaration, LocalsContainer {
  ...
  interface JSDocSignature
    extends JSDocType, Declaration, JSDocContainer, LocalsContainer {
  ...
  interface TupleType extends GenericType {
    ...
    labeledElementDeclarations?:
      readonly (NamedTupleMember | ParameterDeclaration | undefined)[];
  }
  ...
  interface LanguageServiceHost
    extends GetEffectiveTypeRootsHost, MinimalResolutionCacheHost {
    getCompilationSettings(): CompilerOptions;
    getNewLine?(): string;
    getProjectVersion?(): string;
    getScriptFileNames(): string[];
